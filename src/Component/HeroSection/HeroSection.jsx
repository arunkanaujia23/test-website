  ...
  return (
    <section className={`${styles?.heroSection}`}>
      <div className={`container`}>
        <header>
          <div className={styles?.toggleButtonsAndLoginContainer}>
            <div className={styles?.toggleMenu} onClick={toggleMenu}>
              ☰
            </div>
            <div className={styles?.navListItemButton}><a href="#">İletişim</a></div>
          </div>


          {
            isOpen ? (
              <nav className={`${styles?.navBarMobile} ${toggleMenu ? styles?.active : ``}`} >
                <ul className={styles?.navList}>
                  <li onClick={toggleMenu} className={styles?.navListItem}><a href="#">Çözüm ve Hizmetler</a></li>
                  <li onClick={toggleMenu} className={styles?.navListItem}><a href="#">Ürünler</a></li>
                  <li onClick={toggleMenu} className={styles?.navListItem}><a href="#">Teknolojiler</a></li>
                  <li onClick={toggleMenu} className={styles?.navListItem}><a href="#"> İnsan Kaynakları</a></li>
                  <li onClick={toggleMenu} className={styles?.navListItem}><a href="#">Kurumsal</a></li>
